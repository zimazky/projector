...
const Breadcrumbs: React.FC<BreadcrumbsProps> = observer(({ currentPath, onBreadcrumbClick }) => {
	return (
		<div className={styles.breadcrumb}>
			{currentPath.map((segment, index) => (
				<React.Fragment key={segment.id}>
					<span className={styles.breadcrumbItem} onClick={() => onBreadcrumbClick(segment.id)}>
						{segment.name}
					</span>
