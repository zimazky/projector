...
export const AppIcon: React.FC<AppIconProps> = ({ icon, size = 24, color = 'currentColor', className, style }) => {
	return <Icon icon={icon} width={size} height={size} color={color} className={className} style={style} />
}
...
export const Diskette: React.FC = () => {
	return (
		<path
			fill="none"
			d="m2 4a2 2 90 012-2l16 0a2 2 90 012 2l0 16a2 2 90 01-2 2l-16 0a2 2 90 01-2-2l0-16m5-2 0 6a1 1 90 001 1l8 0a1 1 90 001-1l0-6m-2 2a1 1 90 00-2 0l0 3a1 1 90 002 0l0-3"
		/>
	)
}
	...
	return (
		<>
			...
			<path
				fill="#dddddd"
				stroke="none"
				d="m4 9h.5a4.3 4.3 90 01-.1-.9 1 1 0 018.6-.1 2.5 2.5 0 014.1 2.7l.6-.1a1 1 0 01.3 6.4h-14a1 1 0 010-8"
			/>
		</>
	)
}
...
export const Fullscreen: React.FC = () => {
	return (
		<>
			<path
				fill="none"
				d="m2 11 0-7a2 2 0 012-2l16 0a2 2 0 012 2l0 16a2 2 0 01-2 2l-7 0m-1-2a2 2 0 01-2 2l-6 0a2 2 0 01-2-2l0-6a2 2 0 012-2l6 0a2 2 0 012 2l0 6"
			/>
