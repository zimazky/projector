...
import Header, { HeaderIconItem, HeaderMenuItem } from 'src/4-widgets/Header/Header'
...
const App: React.FC = observer(function() {
  ...
  let menu: HeaderMenuItem[] = []
  let icons: HeaderIconItem[] = []
  ...
  return <>
    <Header menuItems={menu} iconItems={icons}/>
